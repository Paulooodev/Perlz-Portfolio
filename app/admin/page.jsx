...
//           value: packs.filter((b) => b.is_published).length,
//           total: packs.length,
//           icon: Package,
//           href: "/admin/packs",  
//         },
...
//                       key={stat.label}
//                       href={stat.href}
//                       className="group bg-[#0a0a0a] border border-white/5 hover:border-primary/30 rounded-2xl p-6 transition-colors"  
//                     >
...
//                             </div>
//                             <span className="text-xs text-gray-500 uppercase tracking-widest font-bold group-hover:text-primary transition-colors">
//                                 Manage →
//                             </span> 
//                         </div>
...
//             className="inline-flex items-center gap-2 h-11 px-5 rounded-lg bg-white/5 hover:bg-white/10 border border-white/10 text-white text-sm font-bold transition-colors"
//           >
//             <Plus size={16} />
//             Upload New Pack
//           </Link>
...
//                 <li>
//                    • Upload <span className="text-white font-bold">tagged preview clips only</span> (30–60s MP3).
//                    Never upload the full WAV. 
//                 </li>
//                 <li>
//                    • Artwork should be <span className="text-white font-bold">square, at least 1000×1000px</span>. 
//                 </li>
//                 <li>
//                     • Unpublish items instead of deleting if you want to hide them temporarily.
//                 </li>
//                 <li>
//                     • Mark your best 3–6 beats as <span className="text-white font-bold">Featured</span> to appear
//                     at the top of the public showcase.
//                 </li>
//            </ul>
//        </div>  
//     </div>
...
const AdminDashboard = async () => {
  ...
  return (
    ...
    <div className="max-w-5xl">
      {/* ============ HEADER ============ */}
      {/* text-2xl base for mobile (was text-3xl which was too aggressive) */}
